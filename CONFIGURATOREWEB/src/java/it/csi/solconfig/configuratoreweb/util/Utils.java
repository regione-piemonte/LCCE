...
public class Utils {
    ...
    public static <T> void copyObjectWithConverter(T orig, T dest) {
        try {
            ...
            org.apache.commons.beanutils.ConvertUtils.register(conv1, Timestamp.class);
            ...
            org.apache.commons.beanutils.ConvertUtils.register(conv3, Long.class);
    ...
    public static Object invokeGetMethod(Object obj, String attrName) {
        ...
        try {
            ...
            if (method != null) {
                ...
                if (retCls.isInstance(Date.class.newInstance())) {
                    Date data = (Date) method.invoke(obj);
    ...
    public static String returnString(StringWriter sw) {
		try {
    ...
    public static String getXmlString(JAXBContext context, Object toMarshal) {
    	String xml = "";
    	try {
			StringWriter sw = new StringWriter();
			JAXBContext jaxbReq = context;
			Marshaller jaxbMarshallerReq = jaxbReq.createMarshaller();
			jaxbMarshallerReq.setProperty(Marshaller.JAXB_FORMATTED_OUTPUT, true);
			jaxbMarshallerReq.marshal(toMarshal, sw);
			xml = returnString(sw);
		} catch (Exception e) {
			e.printStackTrace();
		}
