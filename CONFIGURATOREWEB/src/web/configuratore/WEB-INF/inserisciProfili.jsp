...
<%@ page import="it.csi.solconfig.configuratoreweb.presentation.model.InserisciProfiloModel" %>
	...
	<div class="app-container">
		<div class="app-row justify-content-md-center">
			<div class="col-12 col-lg-8">
				...
				<h1 class="titolocard mt-9">Configurazione nuovo profilo</h1>
			...
			<!-- inizio box dati utente-->
				...
				<div class="card-box card-box-white card-box-notifiche mt-2">
					<div class="card-box-body">
						...
						<form:form id="profForm" action="/configuratore/inserisciProfili" method="post"
								...
								<div class="col-12 col-md-6">
									...
									<div class="form-group mb-2 input-group">
										<label for="servizioOnline" class="bmd-label-floating">SOL</label>
											<form:select class="form-control" id="servizioOnline" path="idApplicazione" onchange="goToSelezionaAlbero()">
													<form:option value="">
																Seleziona...</form:option>
												<c:forEach items="${sessionScope.data.applicazioneDtoList}"
													var="applicazione">
													<form:option value="${applicazione.id}" name="${applicazione.id}">
								...
								<div class="col-12 col-md-6">
									<div class="form-group input-group date">
										...
										<input type="text" class="form-control" id="codice"
											name="codice" value="${profilo.codice}"
											path="codice" maxlength="20"/>
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-12 col-md-6">
									<div class="form-group input-group date">
										...
										<!-- <select class="form-control" id="sedeOperativa">
											<option>Descrizione 1</option>
											<option>Descrizione 2</option>
											<option>Descrizione 3</option>
											<option>Descrizione 4</option>
											<option>Descrizione 5</option>
										</select> -->
								...
								<div class="accordion">
									<div class="card accordion-box azioni-box">
										<div class="card-header" id="headingOne">
											<h3 class="mb-0">
												<button class="btn btn-link text-left collapsed accordion-function" data-toggle="collapse" data-target="#collapseOne"
														aria-expanded="false" aria-controls="collapseOne" onClick="return false;">
													Aggiungi funzionalita' / Azioni al profilo
												</button>
											</h3>
										</div>
													...
													<div class="col-12">
														<div class="form-check">
															...
															<c:if test="${albero.checkNull eq false}">
																<input id="select-all" class="form-check-input" type="checkbox" value="" id="defaultCheck1">
									...
									<%-- <%
									InserisciProfiloModel inserisciProfiloModel = (InserisciProfiloModel) request.getAttribute("profilo");
									if(inserisciProfiloModel.getidApplicazione() != null){
										request.setAttribute("albero", session.getAttribute(inserisciProfiloModel.getidApplicazione().toString()));
									}
									%>	 --%>

									<c:import url="common/showFunctionTree.jsp"/>
									</div>
									<!--vecchio accordion-->
								...
								<div class="row prosegui mt-9">
									<div class="col-md-6 col-12 indietro">
										<a class="btn btn-info btn-primary"
											href="/configuratore/inserimentoProfili" value="annulla">Annulla</a>
									</div>
									<div class="col-md-6 col-12 text-md-right mt-2 mt-md-0">
										<input id="subButton" class="btn btn-primary" type="submit" value="Salva">
									</div>
								</div>
							</div>
						</form:form>
...
function goToSelezionaAlbero(){
	$("#profForm").attr("action", "/configuratore/selezionaAlbero");
	document.getElementById("profForm").submit();
	/*window.location = 'selezionaAlbero';*/
}
</script>
...
<script>
    $(() => profilePage.initDataInsertProfilePage());
</script>
