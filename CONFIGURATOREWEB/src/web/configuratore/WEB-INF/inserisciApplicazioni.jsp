        ...
        <div class="col-12 col-lg-8">
          <div class="link mt-9">
            <a href="${root}/applicazioni" class="link-prev"> Indietro</a>
                  ...
                  <form:form action="${root}/inserimentoNuovaApplicazione" method="post" modelAttribute="applicazione">
		  
          <div class="card-box card-box-white card-box-notifiche mt-2">
              <div class="card-box-body row">
                <div class="col-12">
                  <h1 class="titolocard">Configura nuova Applicazione</h1>
                    ...
                    <div class="row prosegui mt-9">
                      <div class="col-md-6 col-sm-12 conferma">
                        <a class="btn btn-info btn-primary"
							href="${root}/inserimentoNuovaApplicazione" value="annulla">Annulla</a>
                      </div>
