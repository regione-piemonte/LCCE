...
@Component
public class ServiziRichiamatiXmlLowDaoImpl extends EntityBaseLowDaoImpl<ServiziRichiamatiXmlDto, Long> implements ServiziRichiamatiXmlLowDao{
    ...
    public ServiziRichiamatiXmlDto insert(ServiziRichiamatiXmlDto obj) {
        ...
        Query query = entityManager.createNativeQuery("INSERT INTO "+getTableName()+
                ...
                " (:id, :idMessaggio, :idServizio, pgp_sym_encrypt_bytea(:xmlIn, '@encryption_key@'), pgp_sym_encrypt_bytea(:xmlOut, '@encryption_key@'), :dataChiamata, :dataRisposta, :esito, :dataInserimento, :dataAggiornamento)");
    ...
    public void update(ServiziRichiamatiXmlDto obj) {
        ...
        Query query = entityManager.createNativeQuery("UPDATE "+getTableName()+" SET" +
                " XML_OUT = pgp_sym_encrypt_bytea(:xmlOut, '@encryption_key@')," +
