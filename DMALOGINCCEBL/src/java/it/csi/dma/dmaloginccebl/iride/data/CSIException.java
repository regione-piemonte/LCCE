...
public class CSIException extends org.apache.axis.AxisFault implements java.io.Serializable {
	...
	public CSIException(String nestedExcMsg, String nestedExcClassName, String stackTraceMessage) {
	...
	public synchronized boolean equals(Object obj) {
		if (!(obj instanceof CSIException))
			return false;
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = true && ((this.nestedExcMsg == null && other.getNestedExcMsg() == null) || (this.nestedExcMsg != null && this.nestedExcMsg.equals(other
				.getNestedExcMsg()))) && ((this.nestedExcClassName == null && other.getNestedExcClassName() == null) || (this.nestedExcClassName != null && this.nestedExcClassName
				.equals(other.getNestedExcClassName()))) && ((this.stackTraceMessage == null && other.getStackTraceMessage() == null) || (this.stackTraceMessage != null && this.stackTraceMessage
				.equals(other.getStackTraceMessage())));
		__equalsCalc = null;
		return _equals;
	}
	...
	// Type metadata
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(CSIException.class, true);
