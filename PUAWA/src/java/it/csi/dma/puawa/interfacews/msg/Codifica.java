...
@XmlType(name = "codifica", namespace = "http://dma.csi.it/", propOrder = { "codice", "descrizione", "riferimento" })
@XmlSeeAlso({ Errore.class, })
public class Codifica implements java.io.Serializable {
	...
	/**
	 * Modificato per far funzionare la equals di oggetti simili nella lista di
	 * codifiche
	 */
	@Override
