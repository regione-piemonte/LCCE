...
@XmlRootElement(name = "reportOperazioniConsensi")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "reportOperazioniConsensiRequest", propOrder = { "collocazioneRichiedente", "filtriReport",
		"idMessaggio", "richiedente" })
public class ReportOperazioniConsensiRequest {
	...
	public ReportOperazioniConsensiRequest() {
		super();
	}
}
