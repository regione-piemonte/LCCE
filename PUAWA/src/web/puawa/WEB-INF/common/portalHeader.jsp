			...
			<div class="sp_container">
				<div class="sp_row">
					<div class="navbar-header">
						...
						<a class="navbar-brand" href="<c:url value='change'/>"> <span
							class="d-brand-dsk">Punto unico di accesso</span> <span
							class="d-brand-mo"><abbr
								title="Fascicolo Sanitario Elettronico">PUA</abbr></span>
						</a>
					</div>
					<!--fine navbar-header -->
					<div id="utilities">
						...
						</a> <a class="help" href="/ris/application/pua/help/help.shtml" target="_blank" role="button">
						<!--i class="icon-help"></i-->
							<img class="ico_svg"
											...
											<div class="content-dropdown">
												<div class="dropdown-item dropdown-items-item">
													<div class="dropdown-item-sx">
														<h4 class="text-uppercase h6">${sessionScope.data.utente.viewCollocazione.colDescAzienda}</h4>
														<!--nome asl-->
														<c:if
													...
													<div class="dropdown-item-dx">
														<a href="<c:url value='/change'/>">cambia ruolo</a>
													</div>
												</div>
												<div class="dropdown-divider"></div>
												<div class="dropdown-item">
													<p>${sessionScope.data.utente.viewCollocazione.viewNome}</p>
												</div>
												<div class="dropdown-item">
													<p>${sessionScope.data.utente.viewCollocazione.viewIndirizzo}</p>
												</div>
											</div>
										</div>
									</div>
