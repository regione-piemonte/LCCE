...
java -cp %CLI_JAR_PATH%;%CUSTOM_GEN_JAR_PATH% %DEBUG_OPTS% io.swagger.codegen.SwaggerCodegen generate -i ..\src\yaml\configuratore.yaml -l jaxrs-resteasy-eap-csi -o .. --config swagger_config_java.json
...
java -jar %CLI_JAR_PATH% generate -l html -i ..\src\yaml\configuratore.yaml -o ..\docs\yaml