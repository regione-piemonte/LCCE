...
public class ModelCollocazione   {
  ...
  @ApiModelProperty(value = "codice della collocazione")
  ...
  @ApiModelProperty(value = "descrizione della collocazione")
  ...
  @ApiModelProperty(value = "codice dell'azienda")
  ...
  @ApiModelProperty(value = "descrizione del azienda")
