...
@Transactional
public class ProfiloDeleteService extends SOLRESTBaseService{
	...
	private static final String CodiceLogAudit = "AUTH_LOG_147";
	private static final String CodiceServizio = "DELPRO";
	...
	public ProfiloDeleteService(String shibIdentitaCodiceFiscale, String xRequestID, String xForwardedFor, String xCodiceServizio,
	...
	public static final String url = "/applicazioni/{codice_applicazione}/profili/{codice_funzionalita}";
	...
	protected Response execute() {
		...
		try {
			...
			ErroreBuilder funzioneValidatorResponse = funzionalitaPerApplicazioneValidator.validateCodiceProfilo(codiceFunzionalita,codiceApplicazione);
			if (funzioneValidatorResponse != null) {
				Response returnResponse = funzioneValidatorResponse.response();
				return returnResponse;
			}
			
			// aggiunta verifica esistenza abilitazioni attive
			ErroreBuilder abilitazioniAttiveResponse = abilitazioniValidator.verificaAbilitazioniAttive(codiceFunzionalita, codiceApplicazione);
			if (abilitazioniAttiveResponse != null) {
				Response returnResponse = abilitazioniAttiveResponse.response();
				return returnResponse;
			}
			
			putAbilitazioniProfiloService.updateAbilitazioniProfiloPreferenze(codiceFunzionalita, codiceApplicazione, shibIdentitaCodiceFiscale, codiceAzienda);
