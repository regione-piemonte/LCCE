...
public class Utils {
	...
	public static Date toDate(String value) {
		try {
			return getSimpleDateFormatWithSlash().parse(value);
		} catch (Exception e) {
			return null;
		}
	}
	...
	public static Date toComplexDate(String value) {
		try {
			return getComplexDateFormatWithSlash().parse(value);
		} catch (Exception e) {
			return null;
		}
	}
	...
	public static String dateToString(java.util.Date data, boolean complex) {
		try {
			SimpleDateFormat df = getSimpleDateFormatWithSlash();

			if (complex) {
				df = getComplexDateFormatWithSlash();
			}
